$(document).ready(function() {
             ...
             message: 'The mobile number is not valid',
                validators: {
                    ...
                    stringLength: {
                        min: 10,
                        max: 10,
                        message: 'The mobile number must be of 10 digit'
                    },
    ...
    .on('success.form.bv', function(e) {
        ...
        var url = 'https://script.google.com/macros/s/AKfycbzARoQi35B708GVyEmwtLEqt4PHLqj8E4hQUcnDkotjvPP860c/exec';
        var redirectUrl = 'contact-us-thank-you.html';
        // show the loading 
